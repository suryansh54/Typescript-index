...
<ol>
  <li><a href="#1-what-is-typescript" title="What is TypeScript?">What is TypeScript?</a></li>
  <li><a href="#2-features-of-typescript" title="Features of TypeScript?">Features of TypeScript?</a></li>
  <li><a href="#3-why-use-typescript" title="Why Use TypeScript?">Why Use TypeScript?</a></li>
  <li><a href="#4-basic-types" title="Basic Types">Basic Types</a></li>
